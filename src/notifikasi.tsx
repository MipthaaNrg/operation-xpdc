...
function filterClick(type:String){
  ...
  if(type === 'deliver'){
    formData.append('user_id', String(localStorage.getItem('userid')));
    formData.append('fillter', 'deliver');
    setFilter('deliver')
    $("#chipsDeliver").css(css_property);
    $("#chipsSemua").css(css_property_normal);
    $("#chipsPickup").css(css_property_normal);
  }else if(type === 'pickup'){
    formData.append('fillter', 'pickup');
    setFilter('pickup')
    $("#chipsPickup").css(css_property);
    $("#chipsSemua").css(css_property_normal);
    $("#chipsDeliver").css(css_property_normal);
  }else{
    ...
    <IonPage className='anim-scale-out anim-linear'>
      <IonHeader>
       ...
       <div>
        ...
        <IonChip style={{background:"#DEDEDE"}} id='chipsDeliver' onClick={()=>{filterClick('deliver')}}>
          <IonLabel style={{color:"#0000A0"}} >Deliver </IonLabel>
        </IonChip>
        <IonChip style={{background:"#DEDEDE"}} id='chipsPickup' onClick={()=>{filterClick('pickup')}}>
          <IonLabel style={{color:"#0000A0"}}  >Pickup</IonLabel>
        </IonChip>
       </div>
       </IonList>
      <IonContent>
